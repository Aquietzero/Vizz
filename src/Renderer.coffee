...
class Renderer
  ...
  # mouse move.
  initMouseEvents: ->
    @mouseHandler = new Mouse(@)
    
    # Add event handler.
    @renderer.domElement.addEventListener('mousemove', @mouseHandler.onMouseMove, false)
    @renderer.domElement.addEventListener('mousedown', @mouseHandler.onMouseDown, false)
    @renderer.domElement.addEventListener('mouseup',   @mouseHandler.onMouseUp, false)
